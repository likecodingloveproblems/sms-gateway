...
func (x *ReserveDebitRequest) GetReferenceId() []byte {
	if x != nil {
...
func (x *CancelDebitRequest) GetReferenceId() []byte {
	if x != nil {
		return x.ReferenceId
	}
	return nil
...
const file_accounting_accounting_proto_rawDesc = "" +
	...
	"\freference_id\x18\x03 \x01(\fR\vreferenceId\"S\n" +
	...
	"\auser_id\x18\x01 \x01(\x04R\x06userId\x12\x16\n" +
	"\x06amount\x18\x02 \x01(\x04R\x06amount\x12!\n" +
	"\freference_id\x18\x03 \x01(\fR\vreferenceId\"R\n" +
	...
	"\vCancelDebit\x12\x1e.accounting.CancelDebitRequest\x1a\x1f.accounting.CancelDebitResponseB\x17Z\x15grpc-accounting/pb;pbb\x06proto3"
...
var file_accounting_accounting_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
